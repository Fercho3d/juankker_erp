...
@section('content')
    <h1 style="font-size:22px;margin:0 0 12px;">Te invitamos al ERP de Juancker</h1>
    <p style="margin:0 0 16px;color:#475569;">
        Fuiste invitado a probar el ERP de Juancker con una cuenta de prueba de <strong>30 días</strong>.
