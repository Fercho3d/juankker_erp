...
@section('content')
    ...
    <p style="margin:0 0 16px;color:#475569;">
        {{ __(':nombre te sumó a su equipo en Juancker ERP con el perfil :perfil. Crea tu contraseña con el siguiente botón.', ['nombre' => $invitadoPor, 'perfil' => __($invitacion->role->nombre)]) }}
    </p>
