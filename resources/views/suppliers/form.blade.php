...
@section('content')
    <div class="max-w-[900px] mx-auto px-6 py-8">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">{{ $supplier->exists ? __('Editar Proveedor') : __('Nuevo Proveedor') }}</h1>
                <p class="text-sm text-gray-500 mt-0.5">{{ $supplier->exists ? __('Actualiza los datos del proveedor.') : __('Llena los datos para dar de alta un nuevo proveedor.') }}</p>
            </div>
            <a href="{{ route('proveedores.index') }}" class="px-5 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-500 hover:border-gray-400 hover:text-gray-700 transition-colors no-underline">← {{ __('Volver a la lista') }}</a>
        </div>
        ...
        <form method="POST" action="{{ $supplier->exists ? route('proveedores.update', $supplier) : route('proveedores.store') }}">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6 hover:shadow-md transition-shadow">
                <div class="flex items-start gap-4 mb-6 pb-5 border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ __('Información fiscal del proveedor según el SAT.') }}</p>
                    </div>
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label for="tipo_persona" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Tipo de Persona') }} *</label>
                        <select id="tipo_persona" name="tipo_persona" class="w-full px-3 py-3 border border-gray-200 rounded-xl text-sm transition-colors box-border focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20 @error('tipo_persona') border-red-400 focus:border-red-500 focus:ring-red-500/20 @enderror" required>
                            ...
                            <option value="Física" {{ old('tipo_persona', $supplier->tipo_persona) === 'Física' ? 'selected' : '' }}>{{ __('Persona Física') }}</option>
                            <option value="Moral" {{ old('tipo_persona', $supplier->tipo_persona) === 'Moral' ? 'selected' : '' }}>{{ __('Persona Moral') }}</option>
                        </select>
                        @error('tipo_persona')
                    ...
                    <div class="mb-4">
                        <label for="razon_social" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Razón Social / Nombre') }} *</label>
                        <input id="razon_social" type="text" class="w-full px-3 py-3 border border-gray-200 rounded-xl text-sm transition-colors box-border focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20 @error('razon_social') border-red-400 focus:border-red-500 focus:ring-red-500/20 @enderror"
                            ...
                            placeholder="{{ __('Ej: Insumos Industriales S.A. de C.V.') }}">
                        @error('razon_social')
                            <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label for="rfc" class="block text-sm font-medium text-gray-900 mb-2">{{ __('RFC') }} *</label>
                        <input id="rfc" type="text" class="w-full px-3 py-3 border border-gray-200 rounded-xl text-sm transition-colors box-border focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20 @error('rfc') border-red-400 focus:border-red-500 focus:ring-red-500/20 @enderror"
                            ...
                            placeholder="{{ __('Ej: XAXX010101000') }}" style="text-transform: uppercase;">
                        @error('rfc')
                            <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="curp" class="block text-sm font-medium text-gray-900 mb-2">{{ __('CURP') }} <small class="text-gray-500">{{ __('(solo personas físicas)') }}</small></label>
                        <input id="curp" type="text" class="w-full px-3 py-3 border border-gray-200 rounded-xl text-sm transition-colors box-border focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20 @error('curp') border-red-400 focus:border-red-500 focus:ring-red-500/20 @enderror"
                            ...
                            placeholder="{{ __('Ej: XEXX010101HNEXXXA4') }}" style="text-transform: uppercase;">
                        @error('curp')
                            <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label for="regimen_fiscal" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Régimen Fiscal') }} *</label>
                    ...
                    <div class="mb-4">
                        <label for="uso_cfdi" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Uso de CFDI') }} *</label>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6 hover:shadow-md transition-shadow">
                <div class="flex items-start gap-4 mb-6 pb-5 border-b border-gray-200">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900 mb-0.5">{{ __('Contacto') }}</h2>
                        <p class="text-sm text-gray-500">{{ __('Datos de contacto del proveedor.') }}</p>
                    </div>
                </div>

                <div class="mb-4">
                    <label for="contacto_nombre" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Nombre del Contacto') }}</label>
                    <input id="contacto_nombre" type="text" class="w-full px-3 py-3 border border-gray-200 rounded-xl text-sm transition-colors box-border focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20 @error('contacto_nombre') border-red-400 focus:border-red-500 focus:ring-red-500/20 @enderror"
                        ...
                        placeholder="{{ __('Ej: Lic. Juan Pérez') }}">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label for="email" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Correo Electrónico') }} *</label>
                        <input id="email" type="email" class="w-full px-3 py-3 border border-gray-200 rounded-xl text-sm transition-colors box-border focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20 @error('email') border-red-400 focus:border-red-500 focus:ring-red-500/20 @enderror"
                            ...
                            placeholder="{{ __('ventas@proveedor.com') }}">
                        @error('email')
                            <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="telefono" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Teléfono') }}</label>
                        <input id="telefono" type="text" class="w-full px-3 py-3 border border-gray-200 rounded-xl text-sm transition-colors box-border focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20 @error('telefono') border-red-400 focus:border-red-500 focus:ring-red-500/20 @enderror"
                            ...
                            placeholder="{{ __('Ej: 55 9876 5432') }}">
                        @error('telefono')
                            <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6 hover:shadow-md transition-shadow">
                <div class="flex items-start gap-4 mb-6 pb-5 border-b border-gray-200">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900 mb-0.5">{{ __('Dirección') }}</h2>
                        <p class="text-sm text-gray-500">{{ __('Domicilio fiscal del proveedor.') }}</p>
                    </div>
                </div>

                <div class="mb-4">
                    <label for="calle" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Calle') }} *</label>
                    <input id="calle" type="text" class="w-full px-3 py-3 border border-gray-200 rounded-xl text-sm transition-colors box-border focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20 @error('calle') border-red-400 focus:border-red-500 focus:ring-red-500/20 @enderror"
                        ...
                        placeholder="{{ __('Ej: Blvd. Manuel Ávila Camacho') }}">
                    @error('calle')
                        <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="mb-4">
                        <label for="num_exterior" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Núm. Exterior') }} *</label>
                    ...
                    <div class="mb-4">
                        <label for="num_interior" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Núm. Interior') }}</label>
                    ...
                    <div class="mb-4">
                        <label for="codigo_postal" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Código Postal') }} *</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label for="colonia" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Colonia') }} *</label>
                    ...
                    <div class="mb-4">
                        <label for="ciudad" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Ciudad / Municipio') }} *</label>
                        <input id="ciudad" type="text" class="w-full px-3 py-3 border border-gray-200 rounded-xl text-sm transition-colors box-border focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20 @error('ciudad') border-red-400 focus:border-red-500 focus:ring-red-500/20 @enderror"
                            ...
                            placeholder="{{ __('Ej: Miguel Hidalgo') }}">
                        @error('ciudad')
                            <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                ...
                <div class="mb-4">
                    <label for="estado" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Estado') }} *</label>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6 hover:shadow-md transition-shadow">
                <div class="flex items-start gap-4 mb-6 pb-5 border-b border-gray-200">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900 mb-0.5">{{ __('Observaciones') }}</h2>
                        <p class="text-sm text-gray-500">{{ __('Notas adicionales y estatus del proveedor.') }}</p>
                    </div>
                </div>

                <div class="mb-4">
                    <label for="notas" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Notas') }}</label>
                    <textarea id="notas" class="w-full px-3 py-3 border border-gray-200 rounded-xl text-sm transition-colors box-border focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20 resize-y min-h-[80px] @error('notas') border-red-400 focus:border-red-500 focus:ring-red-500/20 @enderror"
                        name="notas" rows="3" placeholder="{{ __('Observaciones opcionales sobre el proveedor...') }}">{{ old('notas', $supplier->notas) }}</textarea>
                    @error('notas')
                        <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
            ...
            <div class="flex items-center justify-between mt-2">
                <a href="{{ route('proveedores.index') }}" class="px-5 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-500 hover:border-gray-400 hover:text-gray-700 transition-colors no-underline">{{ __('Cancelar') }}</a>
                <button type="submit" class="px-6 py-2.5 bg-indigo-600 text-white text-sm font-semibold rounded-xl hover:bg-indigo-700 transition-colors cursor-pointer border-none">
                    {{ $supplier->exists ? __('Guardar Cambios') : __('Crear Proveedor') }}
                </button>
            </div>
        </form>
    </div>
