...
@section('content')
    <div class="max-w-[900px] mx-auto px-6 py-8">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">{{ $client->exists ? __('Editar Cliente') : __('Nuevo Cliente') }}</h1>
                <p class="text-sm text-gray-500 mt-0.5">{{ $client->exists ? __('Actualiza los datos del cliente.') : __('Llena los datos para dar de alta un nuevo cliente.') }}</p>
            </div>
        ...
        <form method="POST" action="{{ $client->exists ? route('clientes.update', $client) : route('clientes.store') }}">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6 hover:shadow-md transition-shadow">
                <div class="flex items-start gap-4 mb-6 pb-5 border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ __('Información fiscal del cliente según el SAT.') }}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <select id="tipo_persona" name="tipo_persona"
                            ...
                            <option value="Física" {{ old('tipo_persona', $client->tipo_persona) === 'Física' ? 'selected' : '' }}>{{ __('Persona Física') }}</option>
                            <option value="Moral" {{ old('tipo_persona', $client->tipo_persona) === 'Moral' ? 'selected' : '' }}>{{ __('Persona Moral') }}</option>
                        </select>
                        @error('tipo_persona')
                    ...
                    <div class="mb-4">
                        ...
                        <input id="razon_social" type="text"
                               ...
                               placeholder="{{ __('Ej: Distribuidora López S.A. de C.V.') }}">
                        @error('razon_social')
                            <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input id="rfc" type="text"
                               ...
                               placeholder="{{ __('Ej: XAXX010101000') }}">
                        @error('rfc')
                            <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="curp" class="block text-sm font-medium text-gray-900 mb-2">{{ __('CURP') }} <small class="text-gray-400 font-normal">{{ __('(solo personas físicas)') }}</small></label>
                        <input id="curp" type="text"
                               ...
                               placeholder="{{ __('Ej: XEXX010101HNEXXXA4') }}">
                        @error('curp')
                            <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6 hover:shadow-md transition-shadow">
                <div class="flex items-start gap-4 mb-6 pb-5 border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ __('Datos de contacto del cliente.') }}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="telefono" type="text"
                               ...
                               placeholder="{{ __('Ej: 55 1234 5678') }}">
                        @error('telefono')
                            <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6 hover:shadow-md transition-shadow">
                <div class="flex items-start gap-4 mb-6 pb-5 border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ __('Domicilio fiscal del cliente.') }}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="num_interior" type="text"
                               ...
                               placeholder="{{ __('Ej: Piso 3, Of. 301') }}">
                        @error('num_interior')
                            <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6 hover:shadow-md transition-shadow">
                <div class="flex items-start gap-4 mb-6 pb-5 border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ __('Notas adicionales y estatus del cliente.') }}</p>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="notas"
                              class="w-full px-3 py-3 border rounded-xl text-sm transition-colors box-border resize-y min-h-[80px]
                                  ...
                                  focus:outline-none focus:ring-2"
                              name="notas" rows="3" placeholder="{{ __('Observaciones opcionales sobre el cliente...') }}">{{ old('notas', $client->notas) }}</textarea>
                    @error('notas')
                        <span class="text-red-500 text-sm mt-1"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
            ...
            <div class="flex items-center justify-between mt-2">
                ...
                <button type="submit"
                    ...
                    {{ $client->exists ? __('Guardar Cambios') : __('Crear Cliente') }}
                </button>
            </div>
        </form>
    </div>
